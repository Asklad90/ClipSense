...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap text-sm font-medium transition-[color,box-shadow,transform] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-transparent text-primary hover:scale-[1.03] duration-300 transition-transform",
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
        outline:
          "border border-zinc-200/50 dark:border-white/[0.08] bg-transparent backdrop-blur-md hover:bg-zinc-100/30 dark:hover:bg-white/[0.02] text-zinc-800 dark:text-zinc-200",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        orange: "bg-digital-orange/20 border border-digital-orange/45 text-digital-orange dark:text-digital-orange font-bold hover:scale-[1.03] hover:bg-digital-orange/25 duration-300 transition-transform shadow-[0_0_20px_rgba(255,92,26,0.15)]",
        violet: "bg-cyber-violet/20 border border-cyber-violet/45 text-cyber-violet dark:text-cyber-violet font-bold hover:scale-[1.03] hover:bg-cyber-violet/25 duration-300 transition-transform shadow-[0_0_20px_rgba(123,97,255,0.15)]",
        glass: "bg-white/[0.05] dark:bg-white/[0.02] border border-white/[0.12] dark:border-white/[0.06] text-zinc-800 dark:text-zinc-200 hover:scale-[1.03] hover:bg-white/[0.08] dark:hover:bg-white/[0.04] duration-300 transition-transform shadow-[0_4px_24px_rgba(0,0,0,0.1)]",
      },
      size: {
